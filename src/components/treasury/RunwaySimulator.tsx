  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 rounded-xl border border-[#E6DFD5] bg-[#FCFBF8] p-4">
        <div>
          <div className="flex items-center gap-2">
            <TrendingUp className="h-4 w-4 text-[#4E7358]" />
            <h2 className="text-sm font-semibold text-[#2D1E17]">Monte Carlo Runway & Liquidity Modeler</h2>
          </div>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
        {/* P10 Stress Case */}
        <div className="rounded-xl border border-[#E6DFD5] bg-[#F5F0E6] p-4">
          <div className="flex items-center justify-between text-xs text-[#68554A] font-medium">
            <span>P10 Stress Case (Worst 10%)</span>
            <ShieldAlert className="h-3.5 w-3.5 text-[#68554A]" />
          </div>
          <div className="mt-2 text-xl font-bold text-[#2D1E17] font-mono">
            {simulation.p10WorstCaseRunwayMonths} <span className="text-xs font-normal text-[#68554A]">Months</span>
          </div>
          <p className="text-[11px] text-[#68554A] mt-1">Severe revenue contraction & market contraction</p>
        </div>

        {/* P50 Expected Median */}
        <div className="rounded-xl border border-[#E6DFD5] bg-[#FCFBF8] p-4">
          <div className="flex items-center justify-between text-xs text-[#68554A] font-medium">
            <span>P50 Expected Median</span>
            <Hourglass className="h-3.5 w-3.5 text-[#68554A]" />
          </div>
          <div className="mt-2 text-xl font-bold text-[#2D1E17] font-mono">
            {simulation.projectedRunwayMonths} <span className="text-xs font-normal text-[#68554A]">Months</span>
          </div>
          <p className="text-[11px] text-[#68554A] mt-1">Estimated zero-cash date: <strong className="text-[#2D1E17] font-medium">{simulation.cashExhaustionDate}</strong></p>
        </div>
        ...
        <div className="rounded-xl border border-[#E6DFD5] bg-[#F5F0E6] p-4">
          ...
          <div className="mt-2 text-xl font-bold text-[#2D1E17] font-mono">
            {simulation.p90BestCaseRunwayMonths}+ <span className="text-xs font-normal text-[#68554A]">Months</span>
          </div>
          <p className="text-[11px] text-[#68554A] mt-1">Strong growth & operating leverage</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-12">
        ...
        <div className="lg:col-span-7 rounded-xl border border-[#E6DFD5] bg-[#FCFBF8] p-4">
          <div className="flex items-center justify-between pb-3">
            <div>
              <h3 className="text-xs font-semibold text-[#2D1E17]">Cash Reserve Fan Curve (₹ Crores)</h3>
              <p className="text-[11px] text-[#68554A]">P90 (Bull) ↔ P50 (Expected) ↔ P10 (Stress) 24-Month Projection</p>
            </div>
          </div>
          ...
          <div className="mt-3 rounded-lg border border-[#E6DFD5] bg-[#F5F0E6] p-3 space-y-1">
            <div className="flex items-center gap-1.5 text-xs font-medium text-[#68554A]">
            ...
            {simulation.aiStrategicRecommendations.map((rec, i) => (
              <p key={i} className="text-[11px] text-[#68554A] leading-relaxed">• {rec}</p>
            ))}
          </div>
        </div>

        {/* Right: Interactive What-If Scenario Builder (5 cols) */}
        <div className="lg:col-span-5 rounded-xl border border-[#E6DFD5] bg-[#FCFBF8] p-4 space-y-4">
          <div className="flex items-center justify-between border-b border-[#E6DFD5] pb-2.5">
            <div className="flex items-center gap-2">
              <Sliders className="h-3.5 w-3.5 text-[#68554A]" />
              <h3 className="text-xs font-semibold text-[#2D1E17]">What-If Scenario Modeler</h3>
            </div>
            <span className="text-[10px] text-[#68554A] font-mono">Dynamic Simulation</span>
          </div>

          {/* Slider 1: Hiring Headcount Delta */}
          <div className="space-y-1">
            <div className="flex justify-between text-xs">
              <span className="text-[#68554A] flex items-center gap-1.5">
                <Users className="h-3.5 w-3.5 text-[#68554A]" />
                Team Headcount Change
              </span>
              <span className="font-semibold text-[#2D1E17] font-mono">
            ...
            />
            <div className="flex justify-between text-[10px] text-[#68554A]">
              <span>-10 Layoff</span>
              <span>0 (Current)</span>
              <span>+20 Hiring</span>
            </div>
          ...
          <div className="space-y-1">
            <div className="flex justify-between text-xs">
              <span className="text-[#68554A] flex items-center gap-1.5">
                <TrendingUp className="h-3.5 w-3.5 text-[#68554A]" />
                Monthly Revenue Growth Rate
              </span>
              <span className="font-semibold text-[#2D1E17] font-mono">{scenario.monthlyRevenueGrowthPercent}% /mo</span>
            </div>
            <input
              type="range"
              min="-10"
          ...
          <div className="space-y-1">
            <div className="flex justify-between text-xs">
              <span className="text-[#68554A] flex items-center gap-1.5">
                <Cloud className="h-3.5 w-3.5 text-[#68554A]" />
                Cloud & SaaS Optimization
              </span>
              <span className="font-semibold text-[#2D1E17] font-mono">-{scenario.cloudSpendReductionPercent}%</span>
            </div>
            <input
              type="range"
              min="0"
          ...
          <div className="space-y-1">
            <div className="flex justify-between text-xs">
              <span className="text-[#68554A] flex items-center gap-1.5">
                <DollarSign className="h-3.5 w-3.5 text-[#68554A]" />
          ...
          <div className="pt-2 border-t border-[#E6DFD5]">
            <span className="text-[10px] font-medium text-[#68554A] uppercase tracking-wide block mb-1.5">
            ...
            <div className="space-y-1.5">
              {STRESS_PRESETS.map((stress) => (
                <button
                  ...
                  className="w-full flex items-center justify-between rounded-md border border-[#E6DFD5] bg-[#F5F0E6] p-2 text-left hover:border-[#E6DFD5] transition-colors"
                >
                  <div>
                    <div className="text-xs font-medium text-[#2D1E17]">{stress.title}</div>
                    <div className="text-[10px] text-[#68554A]">{stress.impactDescription}</div>
                  </div>
                  <span className="text-xs font-mono font-medium text-[#68554A]">-{stress.runwayReductionMonths}mo</span>
                </button>
              ))}
            </div>
          </div>
